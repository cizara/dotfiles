...
Item {
    ...
    z: 120
    readonly property var cpuService: Services.Cpu

    // theme
    property color ringBg: Services.Theme.colorRingBg
    property color ringFg: {
        if (percent < 70) return Services.Theme.colorRingFgLow
    ...
    // data from service
    readonly property real usedFrac: cpuService.usedFrac
    readonly property int percent: cpuService.percent
    ...
    Item {
        ...
        Rectangle {
            id: tipPill
            implicitHeight: Services.Theme.pillHeight
            implicitWidth: tipTextItem.implicitWidth + Services.Theme.paddingContent
