...
Item {
    ...
    readonly property var diskService: Services.Disk
    ...
    // data from service
    readonly property real usedFrac: diskService.usedFrac
    readonly property real usedGiB: diskService.usedGiB
    readonly property real availGiB: diskService.availGiB
    readonly property real totalGiB: diskService.totalGiB
    readonly property int percent: diskService.percent
    ...
    Rectangle {
        ...
        Text {
            ...
            text: "Disk: " + root.percent + "% - " + root.availGiB.toFixed(1) + "GiB Free"
            color: root.tipText
