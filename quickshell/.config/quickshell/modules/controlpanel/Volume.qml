...
Item {
    ...
    readonly property var speaker: Services.Volume?.defaultSpeaker ?? null
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                color: pressed ? Services.Theme.colorButtonPress : (hovered ? Services.Theme.colorButtonHover : Services.Theme.colorSurface0)
                ...
                Text {
                    ...
                    Behavior on rotation { NumberAnimation { duration: Services.Theme.animDurationVerySlow; easing.type: Easing.OutCubic } }
                }
